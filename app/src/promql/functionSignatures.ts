...
export const functionSignatures: Record<string, Func> = {
  ...
  end: { name: 'end', argTypes: [], variadic: 0, returnType: valueType.scalar, experimental: true },
  ...
  range: { name: 'range', argTypes: [], variadic: 0, returnType: valueType.scalar, experimental: true },
  ...
  start: { name: 'start', argTypes: [], variadic: 0, returnType: valueType.scalar, experimental: true },
  ...
  step: { name: 'step', argTypes: [], variadic: 0, returnType: valueType.scalar, experimental: true },
