...
describe('serializeNode and formatNode', () => {
  it('should serialize correctly', () => {
    const tests: { node: ASTNode; output: string; prettyOutput?: string }[] = [
      ...
      },
      {
        ...
        output: 'metric_name{label1="value1",label2!="value2",label3=~"value3",label4!~"value4"}',
      },
      {
        node: {
          type: nodeType.vectorSelector,
      ...
      // Matrix selectors.
      {
        ...
        output: 'metric_name{label1="value1",label2!="value2",label3=~"value3",label4!~"value4"}[5m] offset 10m',
      },
      {
        node: {
          type: nodeType.matrixSelector,
  ...
  "baz"
      ...
      },
      {
        node: {
          type: nodeType.unaryExpr,
          expr: { type: nodeType.parenExpr, expr: { type: nodeType.placeholder, children: [] } },
          op: unaryOperatorType.minus,
        },
        output: '-(…)',
        prettyOutput: `-(
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToOne, labels: [], on: false, include: [] },
          bool: false,
        },
        output: '… + …',
        prettyOutput: `  …
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToOne, labels: [], on: true, include: [] },
          bool: false,
        },
        output: '… + on() …',
        prettyOutput: `  …
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToOne, labels: ['label1', 'label2'], on: true, include: [] },
          bool: false,
        },
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToOne, labels: ['label1', 'label2'], on: false, include: [] },
          bool: false,
        },
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToMany, labels: ['label1', 'label2'], on: true, include: [] },
          bool: false,
        },
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.oneToMany, labels: ['label1', 'label2'], on: true, include: ['label3'] },
          bool: false,
        },
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.manyToOne, labels: ['label1', 'label2'], on: true, include: [] },
          bool: false,
        },
  ...
  …`,
      },
      {
        node: {
          ...
          lhs: { type: nodeType.placeholder, children: [] },
          rhs: { type: nodeType.placeholder, children: [] },
          matching: { card: vectorMatchCardinality.manyToOne, labels: ['label1', 'label2'], on: true, include: ['label3'] },
          bool: false,
        },
...
== bool on(label1, label2) group_right(label3)
  …`,
    ...
    tests.forEach((t) => {
      ...
      expect(serializeNode(t.node, 0, true)).toBe(t.prettyOutput !== undefined ? t.prettyOutput : t.output);

      const el = document.createElement('span');
      ReactDOM.render(formatNode(t.node, true), el);
      expect(el.textContent).toBe(t.output);
    });
  });
});
